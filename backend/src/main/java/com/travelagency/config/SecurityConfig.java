...
public class SecurityConfig {
    ...
    // Lista de origenes permitidos, separada por comas (app.cors.allowed-origins).
    // Se define en application.properties y se sobreescribe en produccion via la
    // variable de entorno APP_CORS_ALLOWED_ORIGINS, sin recompilar.
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        List<String> origins = Arrays.stream(allowedOrigins.split(","))
                ...
                .toList();
        // setAllowedOriginPatterns (no setAllowedOrigins) acepta "*" y patrones
        // concretos en la misma lista sin lanzar excepcion en tiempo de arranque
